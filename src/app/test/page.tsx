    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground text-center max-w-2xl mx-auto mt-4 mb-8">
          Ready to take the next step? Whether you're seeking clarity, efficiency, or support, 
          I'm here to help. Let's talk and find out how I can assist you in reaching your goals.
        </p>
      </motion.div>
      ...
      >
        <p className="font-medium text-foreground">Alternative Contact Methods</p>
